...
'--arch=i386',
'--cpu=i386',
"--extra-ldflags='-arch i386 -miphoneos-version-min=6.0  -L/Volumes/data/github/OpenSSL-for-iPhone/lib -lssl -lcrypto'",
"--extra-cflags='-arch i386 -miphoneos-version-min=6.0 -I/Volumes/data/github/OpenSSL-for-iPhone/include'",
'--disable-asm',
]
...
'--arch=x86_64',
'--cpu=x86_64',
"--extra-ldflags='-arch x86_64 -miphoneos-version-min=6.0  -L/Volumes/data/github/OpenSSL-for-iPhone/lib -lssl -lcrypto'",
"--extra-cflags='-arch x86_64 -miphoneos-version-min=6.0 -I/Volumes/data/github/OpenSSL-for-iPhone/include'",
'--disable-asm',
]
...
"--extra-ldflags='-arch armv7 -miphoneos-version-min=6.0 -L/Volumes/data/github/OpenSSL-for-iPhone/lib -lssl -lcrypto'",
#"--extra-cflags='-mfpu=neon -mfloat-abi=softfp --enable-openssl -I/Volumes/data/github/OpenSSL-for-iPhone/include'",
"--extra-cflags='-mfpu=neon -mfloat-abi=softfp -I/Volumes/data/github/OpenSSL-for-iPhone/include'",
'--enable-neon',
# '--disable-neon',
...
"--extra-ldflags='-arch armv7s -miphoneos-version-min=6.0  -L/Volumes/data/github/OpenSSL-for-iPhone/lib -lssl -lcrypto'",
"--extra-cflags='-mfpu=neon -mfloat-abi=softfp -I/Volumes/data/github/OpenSSL-for-iPhone/include'",
'--enable-neon',
# '--disable-neon',
'--enable-optimizations',
...
"--extra-ldflags='-arch arm64 -miphoneos-version-min=6.0  -L/Volumes/data/github/OpenSSL-for-iPhone/lib -lssl -lcrypto'",
"--extra-cflags='-mfpu=neon -mfloat-abi=softfp -I/Volumes/data/github/OpenSSL-for-iPhone/include'",
'--enable-neon',
# '--disable-neon',
'--enable-optimizations',
...
#	extra = "--extra-ldflags='-L/usr/local/opt/openssl/lib -lssl -lcrypto' --extra-cxxflags='--enable-openssl -I/usr/local/opt/openssl/include' --extra-cflags='--enable-openssl -I/usr/local/opt/openssl/include'"
	extra = ''
...
task :build_movie_debug do
	...
	system_or_exit "lipo -create -arch armv7 tmp/build/Debug-iphoneos/libkxmovie_armv7.a -arch armv7 tmp/build/Debug-iphoneos/libkxmovie_armv7s.a -arch arm64 tmp/build/Debug-iphoneos/libkxmovie_arm64.a -arch x86_64 tmp/build/Debug-iphonesimulator/libkxmovie_x86_64.a -output tmp/build/Debug-iphoneos/libkxmovie.a"
end
...
task :build_movie_release do
	...
	system_or_exit "lipo -create -arch armv7 tmp/build/Release-iphoneos/libkxmovie_armv7.a -arch armv7 tmp/build/Release-iphoneos/libkxmovie_armv7s.a -arch arm64 tmp/build/Release-iphoneos/libkxmovie_arm64.a -output tmp/build/Release-iphoneos/libkxmovie.a"
end

desc "Copy to output debug folder"
task :copy_movie_debug do	
	dest = ensureDir 'output/debug'	
	FileUtils.move Pathname.new('tmp/build/Debug-iphoneos/libkxmovie.a'), dest		
...
desc "Copy to output relase folder"
task :copy_movie_release do
	dest = ensureDir 'output/release'
        FileUtils.move Pathname.new('tmp/build/Release-iphoneos/libkxmovie.a'), dest
        FileUtils.copy Pathname.new('libs/FFmpeg/libavcodec.a'), dest
        FileUtils.copy Pathname.new('libs/FFmpeg/libavformat.a'), dest
        FileUtils.copy Pathname.new('libs/FFmpeg/libavutil.a'), dest
        FileUtils.copy Pathname.new('libs/FFmpeg/libswscale.a'), dest
...
#task :clean => [:clean_movie_debug, :clean_movie_release]
task :clean => [:clean_movie_release]
...
#task :build_movie => [:build_ffmpeg, :build_movie_debug, :copy_movie_debug, :build_movie_release, :copy_movie_release]
#task :build_movie => [:build_movie_debug, :copy_movie_debug, :build_movie_release, :copy_movie_release]
task :build_movie => [ :build_movie_release, :copy_movie_release]
task :build_all => [:clean, :build_movie] 
